...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const description = `A free AI tool spend audit for a ${audit.team_size}-person team. Tools reviewed: ${
    Array.isArray(audit.tools) ? audit.tools.length : 0
  }.`
